...
using namespace tmathlib;



MeshData Geometry::BuildDiskGeometryBuffers(UINT* NumOfVertex, UINT* NumOfIndice)
{
	...
	*NumOfIndice = 4 * NumOfSlices * 3;
	...
	XMFLOAT3 color = { 1.000000000f, 0.411764741f, 0.705882370f };
	...
	// Return mesh
	MeshData mGeoPointers;
	mGeoPointers.vertices.data = vertices;
	mGeoPointers.vertices.size = *NumOfVertex;
	mGeoPointers.indices.data = indices;
	mGeoPointers.indices.size = *NumOfIndice;
	return mGeoPointers;
}
...
//	float g_LeftBound, float g_RightBound, std::wstring Expression_1, bool BoundToWhat)
//{
...
//	indices = new UINT[*NumOfIndice];
//
//	bool IsBoundToLeft = BoundToWhat;
//
...
//}
//
//MeshData BuildConeGeometryBuffers(UINT * NumOfVertices, UINT * NumOfIndices)
//{
...
//}
//
//void SwapXAndYVertices(MeshData in, UINT NumOfVertices, UINT NumOfIndices)
//{
